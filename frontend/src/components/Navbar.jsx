...
const Navbar = () => {
    ...
    return (
        <nav 
            ...
            style={{ backgroundColor: 'var(--navbar-bg)', borderBottomColor: 'var(--border-color)' }}
        >
                        ...
                        <div className="ml-10 flex items-baseline space-x-8">
                            {navLinks.map((item) => (
                                <Link
                                    key={item.name}
                                    to={item.path}
                                    className={`relative px-3 py-2 text-sm font-medium transition-colors duration-200 ${location.pathname === item.path ? 'text-primary' : 'hover:text-primary'
                                        }`}
                                    style={{ color: location.pathname === item.path ? 'var(--primary)' : 'var(--text-secondary)' }}
                                >
                                    {item.name}
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <div className="hidden md:flex items-center gap-4">
                            <Link to="/wishlist" className="p-2 hover:bg-white/5 rounded-full transition-colors relative group">
                                <Heart className="h-5 w-5 transition-colors" style={{ color: 'var(--text-secondary)' }} />
                            </Link>
                            <Link 
