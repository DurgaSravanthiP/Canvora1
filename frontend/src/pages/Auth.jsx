...
const Auth = () => {
    ...
    return (
        <div className="h-screen flex items-center justify-center p-4 relative overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }}>
            {/* Background Blobs */}
            ...
            <motion.div
                ...
                className="w-full max-w-6xl aspect-[16/9] backdrop-blur-2xl border rounded-[3rem] shadow-2xl overflow-hidden flex flex-col md:flex-row relative z-10"
            ...
            >
                ...
                {/* Right Panel - Form */}
                <div className="w-full md:w-1/2 p-10 md:p-16 flex flex-col justify-center" style={{ backgroundColor: 'var(--bg-secondary)' }}>
                    ...
                    <form className="space-y-12" onSubmit={handleSubmit}>
                        ...
                        {!isLogin && (
                            <div className="mt-4">
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-sm" style={{ color: 'var(--text-secondary)' }}>Password strength</span>
                        ...
                        <button className="relative w-full group overflow-hidden rounded-full py-5 bg-primary text-white font-black uppercase tracking-[0.2em] text-sm hover:scale-[1.02] active:scale-[0.98] transition-all shadow-xl">
                    ...
                    <div className="mt-12 pt-8 border-t text-center" style={{ borderTopColor: 'var(--border-color)' }}>
